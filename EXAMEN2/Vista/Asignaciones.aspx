<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Asignaciones.aspx.cs" Inherits="EXAMEN2.Vista.Asignaciones" %>
...
<div class="section">
    ...
    <div class="form-container">
        ...
        <label for="TextBox3">TecnicoID:</label>
        <asp:TextBox ID="tTecnicoID" runat="server" BackColor="#CCCCCC" BorderColor="Black"></asp:TextBox>

        <label for="TextBox4">Fecha De Asignacion:</label>
        <asp:TextBox ID="tFechaAsig" runat="server" BackColor="#CCCCCC" BorderColor="Black"></asp:TextBox>
