<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reparaciones.aspx.cs" Inherits="EXAMEN2.Vista.Reparaciones" %>
...
<body>
 ...
 <h1>DATOS DE REPARACIONES</h1>
<div class="section">
    <div class="grid-container">
        <asp:GridView ID="GridView" runat="server" Width="400px"></asp:GridView>
    </div>
    <div class="form-container">
        <label for="TextBox1">ID:</label>
        <asp:TextBox ID="tID" runat="server" BackColor="#CCCCCC" BorderColor="Black"></asp:TextBox>

        <label for="TextBox2">EquipoID:</label>
        <asp:TextBox ID="tEquipoID" runat="server" BackColor="#CCCCCC" BorderColor="Black"></asp:TextBox>

        <label for="TextBox3">Fecha Solicitud:</label>
        <asp:TextBox ID="tFechaSol" runat="server" BackColor="#CCCCCC" BorderColor="Black"></asp:TextBox>
